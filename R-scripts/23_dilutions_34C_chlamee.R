...
high_conc1 <- dilutions %>% 
	...
	mutate(combo_needed = 20-volume_needed) %>% 
	...
	select(population, volume_needed, combo_needed_divided_x2)
...
write_csv(all_conc, "data-processed/chlamee-dilutions-34C.csv")
