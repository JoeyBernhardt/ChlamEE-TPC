...
write_csv(temp22, "data-processed/chlamee-acute-exponential.csv")
...
ggsave("figures/exp-growth-chlamee-acute.pdf", width = 15, height = 8)
...
ggsave("figures/growth_pooled_chlamee-acute.pdf", width = 25, height = 15)
